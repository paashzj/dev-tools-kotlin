...
public class DumpAction {
    ...
    public UiResp<String> dump(String host, int port, String username, String password, String podName, String namespace, String pid) {
        try {
            ...
            sshClient.execute("kubectl cp /root/" + jdkFileName + " " + podName + ":/tmp/ -n " + namespace, 120);
            ...
            sshClient.execute("kubectl cp " + podName + ":/tmp/" + podName + ".tar.gz /root/" + podName + ".tar.gz -n " + namespace, 120);
