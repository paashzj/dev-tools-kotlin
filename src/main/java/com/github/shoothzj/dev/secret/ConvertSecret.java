...
public class ConvertSecret {
    ...
    // @desc: convert pem file to jks.
    // path: pem file path.
    // password: relock jks file password.
    public void pem2jks(String crtFile, String keyFile, String password) {
        // step 1: pem to PKCS12.

        // get file basename
        String pkcsFilename = crtFile.split("\\.")[0];
        try {
